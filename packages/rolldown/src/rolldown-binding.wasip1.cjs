...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = require.resolve('@rolldown/binding-wasm32-wasip1/rolldown-binding.wasm32-wasip1.wasm')
  } catch {
    throw new Error('Cannot find rolldown-binding.wasm32-wasip1.wasm file, and @rolldown/binding-wasm32-wasip1 package is not installed.')
  }
}
